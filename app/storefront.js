...
export default function Storefront() {
  ...
  return <main>
    ...
    <section id="produk" className="products-section section-shell">
      <div className="offer-kicker" aria-label="Penawaran terbaik hari ini"><div className="offer-marquee"><span>🔥 PENAWARAN TERBAIK HARI INI • STOK SIAP KIRIM DARI KOTA MAKASSAR</span><span aria-hidden="true">🔥 PENAWARAN TERBAIK HARI INI • STOK SIAP KIRIM DARI KOTA MAKASSAR</span><span aria-hidden="true">🔥 PENAWARAN TERBAIK HARI INI • STOK SIAP KIRIM DARI KOTA MAKASSAR</span></div></div>
